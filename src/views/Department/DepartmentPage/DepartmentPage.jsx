...
import useDisableDepartment from "../hooks/useDisableDepartment";
...
const DepartmentPage = () => {
  ...
  const { data: detail, isLoading: isLoadingDetail } = useGetDepartmentById(id);
  ...
  const { data: response, isLoading } = useGetAllDepartment(filter);
                ...
                <div className="flex justify-between w-full">
                  <Stack spacing={2} direction="row">
                    <BootstrapButton
                      ...
                      onClick={handleOpen}
                    >
                      <i className="fa fa-plus" /> Create Department
                    </BootstrapButton>
                  </Stack>
                  <form
                    onSubmit={(e) => {
                    ...
                    {response.data && (
                      <TableBody>
                        ...
                        >
                          ...
                          <DialogContent sx={{ width: "600px" }}>
                            <>
                              <CreateADepartment closeDialog={handleClose} />
                            </>
                          </DialogContent>
                        </Dialog>
                      </TableBody>
